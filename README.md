...
- 🏆 **Top Donate** — ผู้สนับสนุนยอดสะสมสูงสุด 3 อันดับ ในรูปแบบ **ตารางไม่มีกรอบ** (`01 · ชื่อ · ฿ยอด`) ตัวหนังสือใหญ่เท่ากับการ์ด Last Follow · ควันชุดเดิมครอบทั้งตาราง (โทนทองอ่อน) · สีเลขอันดับ ทอง/เงิน/ทองแดง · นับเฉพาะ **ยอดจริง** (ไม่รวมยอดทดสอบ) · 匿名 → "ไม่ระบุชื่อ"
