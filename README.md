...
- 🏆 **Top Donate** — ผู้สนับสนุนยอดสะสมสูงสุด 3 อันดับ ในรูปแบบ **ตารางไม่มีกรอบ** พร้อมหัวข้อ "Top Donate": `01 · ชื่อ · ฿ยอด` · **ตัวอักษรสไตล์เดียวกับการ์ด Last Follow เป๊ะ** (Montserrat 300/500/600 self-host + Noto Sans Thai fallback · น้ำหนัก 600) แต่ **ตัวใหญ่กว่า ~1.7 เท่า อ่านจากระยะไกล** · **พื้นหลังใสสนิท (ไม่มี plate/ไม่มีกรอบ)** · **ชื่อเป็นสีดำ** · สีเลขอันดับ ทอง/เงิน/ทองแดง · **ควันเปิดไว้แบบเบา ๆ** (ปิดด้วย `?nosmoke=1`) · นับเฉพาะ **ยอดจริง** (ไม่รวมยอดทดสอบ) · 匿名 → "ไม่ระบุชื่อ"
