...
- 🏆 **Top Donate** — ผู้สนับสนุนยอดสะสมสูงสุด 3 อันดับ ในรูปแบบ **ตารางไม่มีกรอบ** พร้อมหัวข้อ "Top Donate": `01 · ชื่อ · ฿ยอด` · ตัวหนังสือใหญ่เท่ากับการ์ด Last Follow · **พื้นหลังใสสนิท (ไม่มี plate/ไม่มีกรอบ)** · **ชื่อเป็นสีดำ** · สีเลขอันดับ ทอง/เงิน/ทองแดง · ควันปิดไว้ (เปิดด้วย `?smokeon=1`) · นับเฉพาะ **ยอดจริง** (ไม่รวมยอดทดสอบ) · 匿名 → "ไม่ระบุชื่อ"
