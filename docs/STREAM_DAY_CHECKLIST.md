...
| **รูปแบบ** | **ตารางไม่มีกรอบ** หนึ่งบรรทัดต่อหนึ่งคน: `01` · ชื่อ · `฿ยอดรวม` (ตัวหนังสือใหญ่เท่ากับการ์ด Last Follow · ไม่มีเส้นคั่น/ไม่มีแท่น/ไม่มีกรอบ) |
...
| ควัน | เอนจินเดิม (ชุดเดียวกับการ์ด Alert/Last Follow) ครอบทั้งตารางเป็นก้อนเดียว โทนทองอ่อน — `?tint=none` ปิดการย้อม · `?nosmoke=1` เอาควันออก |
| ตำแหน่ง/ขนาด | มุมเดิมของการ์ด Last Follow (`bottom-left`) · กว้างกว่าการ์ดเล็กน้อยเพื่อให้ตัวใหญ่ยังอ่านครบ (≈515px @1920) — ปักเองด้วย `?podiumwidthpx=` |
...
| พื้นฝ้าจาง ๆ หลังข้อความ (ไม่มีเส้นขอบ) | `&plate=1` |
| ปรับ/ปิดควัน | `&tint=none` · `&tint=sepia(.9) saturate(2.4)` · `&nosmoke=1` · `&smoke=A2&smokespreadx=1.1&smokefit=1` |
