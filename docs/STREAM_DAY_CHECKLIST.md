...
| ควัน | **ปิดไว้เป็นค่าเริ่มต้น** (ให้พื้นหลังใสตามที่กำหนด) — เปิดได้ด้วย `?smokeon=1` แล้วจูนด้วย `?tint=` / `?smoke=A2` |
...
| เปิด/ปิดควัน (ค่าเริ่มต้น: ปิด) | `&smokeon=1` เปิด · `&tint=none` ไม่ย้อมสี · `&tint=sepia(.9) saturate(2.4)` · `&smoke=A2&smokespreadx=1.1&smokefit=1` |
